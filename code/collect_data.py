...
src1 = server_settings["TMP_STORAGE_SERVER_1"]
src2 = server_settings["TMP_STORAGE_SERVER_2"]
...
tmp1 = ssf.get_hour_files(join(src1, day, hourdirname))
tmp2 = ssf.get_hour_files(join(src2, day, hourdirname))
...
# clean up
shutil.rmtree(join(src1, day, hourdirname))
shutil.rmtree(join(src2, day, hourdirname))